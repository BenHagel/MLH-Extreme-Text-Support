...
Ric.baseURL = 'http://localhost:80/api/';//'http://extremetextsupport.com/api';//  'http://localhost:80/api';//  /'http://www.nimiqgames.ca/api';//
Ric.baseURL_res = 'http://localhost:80/res/';//'http://extremetextsupport.com/res/';//  'http://localhost:80/res/';//   http://localhost:80/res/';
